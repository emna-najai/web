                    ...
                    <div class="row">
                        <div class="col-xs-12 hidden visible-xs">
                            <ul class="list-unstyled social-network text-center">
                                <li><a href="mailto:info@doggyhouse.tn"><i class="icon-message" aria-hidden="true"></i></a></li>
                                <li><a href="tell:+216 00 000 000"><i class="icon-phone-call" aria-hidden="true"></i></a></li>
                                <li><a href="https://www.facebook.com/DOGGYHouseL/" target="_BLANK"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="https://www.youtube.com/channel/UCu_pyx-67zXCXYAy4k_-hhA?disable_polymer=true" target="_BLANK"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                <li><a href="https://www.instagram.com/DoggyHouse/" target="_BLANK"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                        ...
                        <div class="col-xs-12 col-sm-6 hidden-xs">
                            <ul class="list-unstyled contact-info">
                                <li>
                                    <a href="mailto:info@doggyhouse.tn" class="icon pull-left"><i class="icon-message"></i></a>
                                    <div class="align-left pull-left hidden-xs">
                                        <strong>Mail us:</strong>
                                        <a href="mailto:info@doggyhouse.tn">info@doggyhouse.tn</a>
                                    </div>
                                </li>
                                <li>
                                    <a href="#" class="icon pull-left"><i class="icon-phone-call"></i></a>
                                    <div class="align-left pull-left hidden-xs">
                        ...
                        <div class="col-xs-12 col-sm-6 hidden-xs">
                            <div class="social-list">
                                <ul class="list-unstyled social-network">
                                    <li><a href="https://www.facebook.com/Doggyhouse/" target="_BLANK"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCu_pyx-67zXCXYAy4k_-hhA?disable_polymer=true" target="_BLANK"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                    <li><a href="https://www.instagram.com/DoggyHouse/" target="_BLANK"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                </ul>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4 abt-txt">
                            <ul class="contact-list list-unstyled">
                                ...
                                <li><a href="mailto:info@doggyhouse.tn"><span class="icon"><i class="fa fa-envelope-o" aria-hidden="true"></i></span>info@doggyhouse.tn</a></li>
                                <li><a href="#"><span class="icon"><i class="fa fa-phone" aria-hidden="true"></i></span> 
                                +216 93 651 030 </a></li>
                            </ul>
                        </div>

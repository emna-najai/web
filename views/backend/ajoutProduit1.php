      ...
      <div id="content">
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Ajout d'un produit</h6>
          </div>
          <div class="card-body">
            ...
            <form action="ajoutProduit2.php" method="POST" onsubmit="return validate_formprod()" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6 mt-2 mb-2">
                    <input type="text" class="form-control mt-2 mb-2" name="qntProduit" id="qntProduit" placeholder="Quantite du produit">
                  </div>
                  <div class="form-group col-md-6 mt-2 mb-2">
